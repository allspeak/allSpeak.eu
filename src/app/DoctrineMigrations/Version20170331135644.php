...
class Version20170331135644 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE survey_sentence (id INT AUTO_INCREMENT NOT NULL, text VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C19108F23B8BA7C7 (text), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
